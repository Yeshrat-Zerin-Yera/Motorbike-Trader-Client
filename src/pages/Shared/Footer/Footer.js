...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 max-w-[1400px] mx-auto bg-gradient-to-r from-cyan-500 to-blue-500 text-white">
            {/* Details */}
            <div>
                {/* Logo */}
                <img src={Logo} alt="" className='h-24' />
                {/* Brand Name And Starting Date */}
                <p className="font-bold">
                    Motorbike Trader Ltd. <br />Providing Reliable Service Since 2006
                </p>
                {/* Copyright */}
