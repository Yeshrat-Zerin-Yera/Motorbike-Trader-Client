...
const ContactUs = () => {
    ...
    return (
        <div>
            {/* Form */}
            <form onChange={handleGetMailDetails} method="post" action={`mailto:yeshratzerinyera@gmail.com?subject=${subject}&body=${message}`} className='flex items-center flex-col gap-3 p-6 mt-12' style={{ backgroundImage: `url(${ContactUsImg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                {/* Contact Us Title */}
